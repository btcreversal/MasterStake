...
These are the dependencies currently used by masterstake. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/masterstakenl
Keybase  - https://keybase.io/team/masterstake/
