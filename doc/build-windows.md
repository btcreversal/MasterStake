...
Some notes on how to build masterstake for Windows.
...
way. This will install to `c:\workspace\masterstake`, for example:

    make install DESTDIR=/mnt/c/local/masterstake
