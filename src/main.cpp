...
const string strMessageMagic = "masterstake Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // masterstake also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // masterstake also requires low S in sigs
